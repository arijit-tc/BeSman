...
function __besman_create_dev_environment 
{
	...
	# export KOBMAN_ROOT_DIR="$HOME/${BESMAN_ENV_ROOT}"
	mkdir -p ${BESMAN_ENV_ROOT}/dependency
}

function __besman_uninstall_KOBman
{
	local environment=$1
	...
	__besman_echo_white "Removing dev environment for KOBman"
...
function __besman_validate_KOBman
{
	local environment=$1
	if [[ ! -d $BESMAN_ENV_ROOT/$environment ]]; then
		__besman_echo_no_colour "Could not find $BESMAN_ENV_ROOT/$environment"
...
# function __besman_update_KOBman
# {
# 	##TODO:- add the code for updating KOBman dev
# }

# function __besman_upgrade_KOBman
# {
# 	##TODO:- add the code for upgradation 
# }

# function __besman_start_KOBman
# {
# 	##Not Applicable
# }

# function __besman_stop_KOBman
# {
# 	##Not Applicable
# }
